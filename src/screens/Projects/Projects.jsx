    ...
    <div className="projects-page-wrapper ">
      <div className="div-right">
        ...
        <div className="project-wrapper">
          ...
          <a href="https://www.ellethompson.com/">
              <img id="proj-img"
                src="https://i.ibb.co/hMdCqvq/Screen-Shot-2022-09-05-at-5-34-34-PM.png"
                alt="Screen-Shot-2022-09-05-at-5-34-34-PM"
                border="0"
              />
            </a>

            <h4 className="proj2-des1">Software Engineering Portfolio</h4>
            <p className="proj2-des2">Web application created to display software engineering skills using react.js, CSS, and javascript</p>
          ...
          <a href="https://elle-thompson-metime.netlify.app/">
            ...
            <h4 className="proj4-des1"> MeTime</h4>
            <p className="proj4-des2">
          ...
          <div className="proj2-description"></div>

          <div className="proj3"></div>

          <div className="proj3-description"></div> */}
        </div>
      </div>
    </div>
  );
