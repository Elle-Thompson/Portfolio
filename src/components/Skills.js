        ...
        <div >
          {/* <h4>
            ...
            <div id="skills-icons">
                  ...
                  <div id="skills-div"> <img id="skill-icon" alt="" src="https://img.icons8.com/plasticine/50/000000/react.png"/> <p id="skills-text">React </p> </div>
                  <div id="skills-div"> <img id="skill-icon" alt="" src="https://img.icons8.com/ios-filled/50/000000/javascript.png"/> <p id="skills-text">JavaScript </p> </div>
                  ...
                  <div id="skills-div"> <img id="skill-icon" alt="" src="https://img.icons8.com/wired/50/000000/postman-api.png"/> <p id="skills-text">Postman </p> </div>  
                  <div id="skills-div"> <img id="skill-icon" alt="" src="https://img.icons8.com/ios/50/000000/api-settings.png"/> <p id="skills-text">Rest API </p> </div>  
            </div>
