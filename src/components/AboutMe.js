      ...
      <div id="about-me" className="div-right">
        ...
        <div id="about-me" className="about-me">
            <p> <span className="secret"> H </span>
              ...
              as a software developer. I have a diverse background in behavioral
          ...
          <div id="pic1-words" className="pic1-words"> <p>  <span className="secret"> S  </span>till eager to change the world, I began studying to become a social worker. I spent my time volunteering at local childcare centers. Eventually, my focus on sociology turned into behaviorial psychology. After graduating college I chose to work with autistic children. I spent about 2 years as a behavior technician. This is when I noticed how marginalized this particular demographic happened to be. Access to materials that are both child-friendly and friendly to those who are atypically developed seemed difficult to acquire. I set out with a new mission; to create platforms that were both fun and easy to use for atypically developed children. I hope to find work with other people and companies who share my vision. </p> </div>
          <div className="pic2"> <img id="pic2-img"  src="https://i.ibb.co/JxPCb88/kuwait.jpg" alt="kuwait" />
          </div>
          <div id="pic2-words" className="pic2-words"> <p> <span className="secret"> F </span>or as long as I can remember I've wanted to help people for a living. Maybe I would become a police officer? Perhaps a doctor? I was never certain. At the age of 17 I enlisted in the US Air Force as an aircraft mechanic. I was able to gain hands-on experience working with complex systems, both mechanical and electronic. This is when I learned just how much I enjoyed problem solving. </p></div>
...
<div className="hobbies"><h6>Favorite Hobbies</h6> <p>I love to try new things. These are a few of my current favorite hobbies:</p> 
<ul>
    <li>Pottery</li>
    ...
    <p>I'm currently hoping to try skydiving and horseback riding this year.</p>
     </div>
<div className="favorite-books-movies"    > 

<h6>Favorite Books</h6> <p>I love to read anything mystery, sci-fi, fantasy, or psychology related.
    <ul>
